  ...
  return (
    <div className="page">
      ...
      <section className="stat-grid dashboard-stat-grid">
        ...
        <StatCard label="최근 환경 상태" value={latestEnv.envStatus || "없음"} hint={latestEnv.measuredAt || "-"} tone="green" />
        <StatCard label="최근 품질 상태" value={latestQuality.qualityStatus || "없음"} hint={latestQuality.measuredAt || "-"} tone="blue" />
