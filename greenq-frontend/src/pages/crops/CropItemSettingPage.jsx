...
export default function CropItemSettingPage() {
  ...
  if (loading) return <div className="panel"><p className="muted-text">기준값을 DB에서 불러오는 중입니다...</p></div>;
