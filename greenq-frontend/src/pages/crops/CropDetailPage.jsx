...
export default function CropDetailPage() {
  ...
  if (loading) return <div className="panel"><p className="muted-text">작물 상세를 불러오는 중입니다...</p></div>;
