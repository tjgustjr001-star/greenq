...
public class GreenqQueryService {
    ...
    public List<Map<String, Object>> environmentLogs(Long batchId, Long zoneId, Integer hours) {
        ...
        StringBuilder sql = new StringBuilder("""
                select el.env_log_id, el.measured_at, el.batch_id, b.batch_name, z.zone_id, z.zone_name, el.temperature,
    ...
    private Map<String, Object> environmentRowMap(Object[] r) {
        return mapOf(
                ...
                "zoneId", r[4], "zoneName", r[5],
                "temperature", num(r[6]), "humidity", num(r[7]), "co2", num(r[8]), "vpd", num(r[9]),
                "lightIntensity", num(r[10]), "photoperiod", num(r[11]), "lightWavelength", r[12],
                "ph", num(r[13]), "waterTemp", num(r[14]), "ec", num(r[15]), "envStatus", r[16], "dataSource", r[17]
        );
    }
