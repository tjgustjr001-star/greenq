...
(`batch_id`, `zone_id`, `crop_id`, `env_standard_set_id`, `quality_standard_set_id`, `batch_name`, `batch_status`, `start_date`, `expected_end_date`, `actual_end_date`, `planted_quantity`, `qr_token`, `created_by`, `created_at`)
VALUES
(1, 1, 1, 1, 2, 'A구역 상추 2026-05 1차', 'GROWING', '2026-05-01', '2026-05-28', NULL, 240, 'qr_batch_a_lettuce_202605_01', 1, '2026-05-01 11:30:00'),
(2, 2, 2, 3, 4, 'B구역 바질 2026-05 1차', 'GROWING', '2026-05-02', '2026-05-30', NULL, 160, 'qr_batch_b_basil_202605_01', 1, '2026-05-02 09:00:00'),
(3, 3, 1, 1, 2, 'C구역 상추 테스트 배치', 'PLANNED', '2026-05-10', '2026-06-05', NULL, 80, 'qr_batch_c_lettuce_test_01', 1, '2026-05-07 14:00:00');
